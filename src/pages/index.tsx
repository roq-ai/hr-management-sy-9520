  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleashing Potential with HR Management System: Centralize Employee Data, Streamline Payrolls, Simplify Time Tracking, and Empower Performance Evaluations"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleashing Potential with HR Management System: Centralize Employee Data, Streamline Payrolls, Simplify Time Tracking, and Empower Performance Evaluations`}
            </Text>
            <Box
